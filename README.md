...
:::info
:file_folder: 題目附檔：https://github.com/Hsuan0223x/AIS3-2024-pre-exam
:::
## Misc
### Welcome
![image](https://hackmd.io/_uploads/BkOL3lG40.png =60%x)
給新手一個見面禮
:::success
:triangular_flag_on_post: AIS3{Welc0me_to_AIS3_PreExam_2o24!}
::: 

### Quantum Nim Heist
![image](https://hackmd.io/_uploads/rJTn3gMNR.png =50%x)
遊戲畫面如下:
![image](https://hackmd.io/_uploads/HyCDMWz4R.png =50%x)
...
:::success
:triangular_flag_on_post: AIS3{Ar3_y0u_a_N1m_ma57er_0r_a_Crypt0_ma57er?}
::: 

### Three Dimensional Secret
![image](https://hackmd.io/_uploads/rkmtRWXEA.png =50%x)
解開以後是一個封包檔案
說到封包，自然不能離開WireShark
所以把這個檔案用WireShark看，然後找資料的部分，然後用TCP Stream
就會看到一堆神奇的東西
![image](https://hackmd.io/_uploads/r1xWtkfQV0.png =50%x)
...
就有Flag了！
:::success
:triangular_flag_on_post: AIS3{b4d1y_tun3d_PriN73r}
:::

## Web
### Evil Calculator
![image](https://hackmd.io/_uploads/r1d_P7QVA.png =50%x)
直接點網址，進去以後長這樣
...
```
那當然就是把 disabled 改成 enable，這樣計算機的螢幕就變成了我們可以輸入的地方
然後看source code，發現是flask框架，然後flag的路徑就在上層
所以，直接在螢幕上打open('../flag').read()
就直接噴出了Flag
:::success
:triangular_flag_on_post: AIS3{7RiANG13_5NAK3_I5_50_3Vi1}
::: 

## Reverse
### The Long Print
![image](https://hackmd.io/_uploads/rkxV9XQE0.png =50%x)
解壓縮出來後，是一個執行檔，執行看看
結果發現，好像甚麼都沒有發生？
...
:::success
:triangular_flag_on_post: AIS3{You_are_the_master_of_time_management!!!!?}
:::


### 火拳のエース
![image](https://hackmd.io/_uploads/ryTo5m74C.png =50%x)
...
~~注意它印出來的G0D是0，不是O~~
:::success
:triangular_flag_on_post: AIS3{G0D_D4MN_4N9R_15_5UP3R_P0W3RFU1!!!}
:::
...
```
:::success
:triangular_flag_on_post: AIS3{NeverUseTheCryptographyLibraryImplementedYourSelf}
:::
## Pwn
對不起，我不會；；
---
